...
> **제거된 기능의 설계다(superseded).** Codex 패리티 계층은 2026-09-03 커밋 `cad0736`에서 걷어냈고 지금 이 플러그인은 Claude Code에서만 돈다. 왜 만들었고 어떻게 배선했는지의 판단만 쓸모가 있어 남겨 두는 것이니, 지금 동작의 근거로 읽지 마라.
