...
## 출력 스키마 (공통)
```
{ "lens": "adversarial", "issues": [ { "severity": "critical|major|minor", "type": "failure-mode|over-engineering|irreversible|scope|risk", "where": "문서 내 위치", "detail": "위험과 이유; 단순화면 그 근거" } ], "notes": "" }
```
