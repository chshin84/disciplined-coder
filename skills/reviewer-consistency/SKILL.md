...
description: 설계 문서(spec/plan)의 내부 모순·커버리지 공백·산출물 공백·이름/타입 드리프트·스코프를 보는 리뷰어 렌즈. domain-spec-review가 읽기 전용 서브에이전트로 호출한다.
---
